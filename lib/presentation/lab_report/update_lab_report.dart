...
import 'controller/update_lab_report_controller.dart';

class UpdateLabReport extends GetView<UpdateLabReportController> {
  UpdateLabReport({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final args = ModalRoute.of(context)!.settings.arguments as Map;
    controller.name.value.text = args['name'];
    controller.age.value.text = args['age'];
    controller.selectedSex.value = args['sex'];
    controller.op.value.text = args['ip_op'];
    controller.doctor.value.text = args['doctor'];
    controller.date.value.text = args['date'];
    controller.tech.value.text = args['lab_tech'];
    controller.heamoglobin.value.text = args['haemoglobin'];
    controller.total_wbc_count.value.text = args['wbc'];
    controller.dc_neutrophil.value.text = args['neutrophil'];
    controller.lymphocyte.value.text = args['lymphocyte'];
    controller.eosinophil.value.text = args['eosinophil'];
    controller.basophil.value.text = args['basophil'];
    controller.monocyte.value.text = args['monocyte'];
    controller.esr.value.text = args['esr'];
    controller.platelet_count.value.text = args['platelet'];
    controller.malarial_parasite.value.text = args['parasite'];
    controller.albumin.value.text = args['albumin'];
    controller.sugar.value.text = args['sugar'];
    controller.microscopy.value.text = args['microscopy'];
    controller.puscells.value.text = args['puscells'];
    controller.rbcs.value.text = args['rbc'];
    controller.epithelial.value.text = args['epithelial'];
    controller.crystal.value.text = args['crystals'];
    controller.casts.value.text = args['casts'];
    controller.bacteria.value.text = args['bacteria'];
    controller.bile_salt.value.text = args['bile_salt'];
    controller.bile_pigment.value.text = args['bile_pigment'];
    controller.sodium.value.text = args['sodium'];
    controller.potassium.value.text = args['potassium'];
    controller.fbs.value.text = args['fbs'];
    controller.rbs.value.text = args['rbs'];
    controller.ppbs.value.text = args['ppbs'];
    controller.hba1c.value.text = args['hba1c'];
    controller.t_cholestrol.value.text = args['t_cholestrol'];
    controller.triglycerides.value.text = args['triglycerides'];
    controller.hdl.value.text = args['hdl'];
    controller.ldl.value.text = args['ldl'];
    controller.vldl.value.text = args['vldl'];
    controller.tbirirubin.value.text = args['t_bilirubin'];
    controller.dbilirubin.value.text = args['d_bilirubin'];
    controller.sgot.value.text = args['sgot'];
    controller.sgpt.value.text = args['sgpt'];
    controller.tprotien.value.text = args['t_protein'];
    controller.albumin1.value.text = args['albumin1'];
    controller.globulin.value.text = args['globulin'];
    controller.ag_ratio.value.text = args['a_g_ratio'];
    controller.alakine_phos.value.text = args['alkaline_phosphatase'];
    controller.urea.value.text = args['urea'];
    controller.screat.value.text = args['s_creatinine'];
    controller.suricacid.value.text = args['s_uric_acid'];
    controller.hiv.value.text = args['hiv'];
    controller.hbsag.value.text = args['hbsag'];
    controller.rdt.value.text = args['rdt'];
    controller.dengue.value.text = args['dengue'];
    controller.ns1ag.value.text = args['ns_1_ag'];
    controller.lgg1gm.value.text = args['lgg_1gm'];
    controller.lepto.value.text = args['lepto_lgG_1gM'];
    controller.docId.value = args['id'];
    return SafeArea(
      child: Scaffold(
        appBar: _buildAppBar(),
        body: Obx(
