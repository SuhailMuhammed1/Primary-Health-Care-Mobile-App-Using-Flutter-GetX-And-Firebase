...
class UpdateLabReportController extends GetxController {
  ...
  void updateReport() {
    final UpdateLabReportController controller = Get.find<UpdateLabReportController>();
    ...
    controller.lab.doc(docId.value).update(data).whenComplete(() => Get.snackbar('Updated',
